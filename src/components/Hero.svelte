...
<SectionWrapper>
    ...
    <div class="flex flex-col gap-10 flex-1 items-center justify-center pb-10 md:pb-14">
        ...
        lg:text-8xl max-w-[1200px] mx-auto w-full text-center">
            <span class="text-indigo-400">Gym</span> 
            Traiining <span class="text-slate-600 
            line-through">Is Hard</span><br/>
        ...
        <p class="text-xl sm:text-2xl md:text-3xl text-center max-w-[1000px] mx-auto w-full">
            Less thinking and more doing. We're the trainer in your pocket full of
            <span class="italic">Personal workouts, exercise explanations, analytics</span>
            and much much more.
        </p>
        <CtAs/>
